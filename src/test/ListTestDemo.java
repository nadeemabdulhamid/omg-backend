...
public class ListTestDemo {
    ...
    public void demo2() {
        ...
        listM.add(40);
        listM.add(20);
        // listM.remove(40);   // exception!
        listM.remove(Integer.valueOf(40)); // remove by value as an object, not index
                        // new Integer(...) is deprecated; use Integer.valueOf(...) instead
                        // because Integer.valueOf(...) uses a cache of small integers
                        // to avoid creating new objects for common values
    }
